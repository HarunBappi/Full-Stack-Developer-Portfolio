...
const Projects = () => {
  ...
  return (
    <section id="projects" className="relative py-5 bg-black overflow-hidden">
        ...
        <FadeIn delay={0}>
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
              <Briefcase className="w-4 h-4 text-primary"></Briefcase>
          ...
          <div className="relative">
            ...
            {filteredProjects.length > 3 && (
              <>
                ...
                >
                  <ChevronLeft className="w-6 h-6 text-white"></ChevronLeft>
                </button>
                <button
                  onClick={nextSlide}
                ...
                >
                  <ChevronRight className="w-6 h-6 text-white"></ChevronRight>
                </button>
              </>
            )}
            {/* navigations Dots */}
