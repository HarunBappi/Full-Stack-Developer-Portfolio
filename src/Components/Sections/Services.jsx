...
const Services = () => {
  return (
    <section id="services" className="relative py-5 bg-black overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to right, white 1px, transparent 1px ),
            (to bottom, white 1px, transparent 1px ),
                `,
        ...
        <FadeIn delay={0}>
            <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                    <Wrench className="w-4 h-4 text-primary"></Wrench>
                    <span className="text-sm font-medium text-primary tracking-wider uppercase">What I Offer</span>
                </div>
                <h2 className="text-3xl lg:text-4xl font-normal text-white mb-4 max-w-2xl mx-auto">Built for Innovation. Designed for results.</h2>
                <p className="text-lg text-white/60 max-w-xl mx-auto">Comprehensive solutions to transform your ideas into exceptional digital experiences.</p>
            </div>
        </FadeIn>
                        ...
                        <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-70 flex flex-col">
                            <div className="mb-6">
                                <div className="w-16 h-16 rounded-2xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <IconComponent className="w-8 h-8 text-primary"></IconComponent>
                                </div>
                            </div>
                        ...
                        <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                            <div className="mb-4">
                                <div className="w-12 h-12 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <IconComponent className="w-6 h-6 text-primary"></IconComponent>
                                </div>
                            </div>
                            <div className="">
